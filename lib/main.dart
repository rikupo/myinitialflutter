...
import 'package:myinitialflutter/measure_page.dart'; //外部ファイルを指定 クラスとかを使えるように.

void main() {
  runApp(const MyApp());
}

//Tips:  基本的におおもとのクラスがデフォであって，それを継承する形で利用する
class MyApp extends StatelessWidget {
  const MyApp({Key? key}) : super(key: key);

  // This widget is the root of your application.
  @override // @override -> extendsで継承した子クラスに対して新規メソッドを追加する．
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            OutlinedButton(
              ...
              style: ElevatedButton.styleFrom(
                primary: Colors.grey, // 全体色？
                onPrimary: Colors.white, // 文字色？
                elevation: 16,
              ),
              child: Text('Measure Mode'),
            )
          ],
        ),
      ),
